...
//to filter the data for parent dropdown value
  ...
  filterSubcategory(Category category) async {
    ...
    final newList = _dataProvider.subCategories
        .where(
          (subcategory) => subcategory.categoryId?.sId == category.sId,
        )
        .toList();
  ...
  filterVariant(VariantType variantType) async {
    ...
    final newList = _dataProvider.variants
        .where(
          (variant) => variant.variantTypeId?.sId == variantType.sId,
        )
        .toList();
